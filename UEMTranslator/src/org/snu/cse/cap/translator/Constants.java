...
public class Constants {
	...
	public static final String TEMPLATE_TAG_SSL_TCP_SERVER_LIST = "ssl_tcp_server_list";
	public static final String TEMPLATE_TAG_SSL_TCP_CLIENT_LIST = "ssl_tcp_client_list";
