...
public class SensorType {
     ...
     * {@link SensorParameterType }
     * 
     * 
     */
    public List<SensorParameterType> getParameter() {
        if (parameter == null) {
            parameter = new ArrayList<SensorParameterType>();
        }
     ...
     * 
     */
    public List<SensorValueType> getValue() {
        if (value == null) {
            value = new ArrayList<SensorValueType>();
        }
        return this.value;
    }
