...
//				System.out.println("MERONG2");
	...
	public void printReadyInstances()
	{
		for(Instance i : ready_list)
		{
			System.out.println ( " Mapped Proc [ " + i.get_node().get_mappedProc()+ " ] , NodeID [ "+i.get_node().get_id()+"  ], InstanceID [ "+i.get_id()+" ] ");
		}
	}
