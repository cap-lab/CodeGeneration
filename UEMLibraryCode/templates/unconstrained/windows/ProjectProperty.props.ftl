...
<Project ToolsVersion="4.0" xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  ...
  <ItemDefinitionGroup>
    <ClCompile>
      <AdditionalIncludeDirectories>$(ProjectDir)$(MAIN_DIR)\include;$(ProjectDir)$(API_DIR)\include;$(ProjectDir)$(KERNEL_DIR)\include;$(ProjectDir)$(KERNEL_DIR)\include\$(ENCRYPTION_DIR);$(ProjectDir)$(KERNEL_DIR)\$(DEVICE_RESTRICTION)\include;$(ProjectDir)$(KERNEL_DIR)\$(DEVICE_RESTRICTION)\include\$(ENCRYPTION_DIR);$(ProjectDir);$(ProjectDir)$(COMMON_DIR)\include;$(ProjectDir)$(COMMON_DIR)\include\$(ENCRYPTION_DIR);$(ProjectDir)$(COMMON_DIR)\$(DEVICE_RESTRICTION)\include;$(ProjectDir)$(COMMON_DIR)\$(DEVICE_RESTRICTION)\include\communication;$(ProjectDir)$(MODULE_DIR)\include;$(ProjectDir)$(MAIN_DIR)\$(DEVICE_RESTRICTION);$(ProjectDir)$(MAIN_DIR)\$(DEVICE_RESTRICTION)\$(NATIVE_DIR);$(ProjectDir)$(KERNEL_DIR)\$(DEVICE_RESTRICTION)\include\communication;$(ProjectDir)$(COMMON_DIR)</AdditionalIncludeDirectories>
