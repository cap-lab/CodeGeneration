...
static uem_result copyAndMovePointerToRoundedQueue(SChannel *pstChannel, SSharedMemoryChannel *pstSharedMemoryChannel, unsigned char *pSrc, int nDataToWrite, int nChunkIndex)
{
	uem_result result = ERR_UEM_UNKNOWN;
	int nSegmentLen = 0;
	int nRemainderLen = 0;
