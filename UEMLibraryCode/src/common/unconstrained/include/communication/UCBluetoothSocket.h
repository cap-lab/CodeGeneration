...
#ifndef SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCBLUETOOTHSOCKET_H_
#define SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCBLUETOOTHSOCKET_H_
...
#endif /* SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCBLUETOOTHSOCKET_H_ */
