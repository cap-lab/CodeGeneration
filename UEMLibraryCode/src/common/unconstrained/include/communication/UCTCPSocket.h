...
#ifndef SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCTCPSOCKET_H_
#define SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCTCPSOCKET_H_
...
#endif /* SRC_COMMON_UNCONSTRAINED_INCLUDE_COMMUNICATION_UCTCPSOCKET_H_ */
