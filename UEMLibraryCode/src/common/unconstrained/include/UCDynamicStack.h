...
#ifndef SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICSTACK_H_
#define SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICSTACK_H_
...
#endif /* SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICSTACK_H_ */
