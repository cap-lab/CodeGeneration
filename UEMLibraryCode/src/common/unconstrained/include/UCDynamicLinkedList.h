...
#ifndef SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICLINKEDLIST_H_
#define SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICLINKEDLIST_H_
...
#endif /* SRC_COMMON_UNCONSTRAINED_INCLUDE_UCDYNAMICLINKEDLIST_H_ */
