...
CIC_TYPEDEF CIC_T_VOID  (*CIC_UT_TRANSITION_FUNC)(CIC_T_VOID);
...
CIC_TYPEDEF CIC_T_INT   (*CIC_UT_GET_TASK_REPEAT_COUNT_FUNC)(CIC_T_CHAR*);
...
CIC_TYPEDEF CIC_T_ENUM {STATE_RUN, STATE_STOP, STATE_WAIT} CIC_UT_TASK_STATE;
...
CIC_TYPEDEF CIC_T_STRUCT{
    CIC_T_INT task_id;
    CIC_T_BOOL is_sdf;
    CIC_UT_MTM_INITIALIZE_FUNC MTMInitialize;
