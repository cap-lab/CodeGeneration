...
CIC_TYPEDEF CIC_T_INT   (*CIC_UT_GET_TASK_ITER_COUNT_FROM_MODE_NAME_FUNC) (CIC_T_CHAR*, CIC_T_CHAR*);
...
CIC_TYPEDEF CIC_T_STRUCT{
    ...
    CIC_UT_GET_TASK_ITER_COUNT_FROM_MODE_NAME_FUNC GetTaskIterCountFromModeName;
